...
const articlePath = {
    ...
    "/articles/list/{path}": {
        get: {
            ...
            responses: {
                "201": {
                    description: "`data` get one article information by article path success",
                    schema: {
                        type: "object",
        ...
        get: {
            ...
            parameters: [
                ...
                },
                {
                    ...
                    name: "sorting",
                    type: "string",
                    description: "article sorting(optional): one of `asc` or `desc`(case-insensitive)",
                    required: false,
                },
            ],
            responses: {
